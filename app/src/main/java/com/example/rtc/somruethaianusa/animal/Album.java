...
import com.example.rtc.somruethaianusa.animal.R;

/**
 * Created by ACER on 16/10/2559.
 */

public class Album extends BaseAdapter{
    ...
    public Album(Context context, String[] titleStrings, String[] detailStrings, int[] ints) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.activity_album, parent, false);
